import{_ as s,X as r,Y as l,Z as t,a0 as e,a2 as a,$ as n,a3 as d,F as c}from"./framework-c2ea1030.js";const o={},p=e("h1",{id:"项目部署",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#项目部署","aria-hidden":"true"},"#"),a(" 项目部署")],-1),m=d(`<h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2><h3 id="docker-容器日期与宿主主机时间不一致解决" tabindex="-1"><a class="header-anchor" href="#docker-容器日期与宿主主机时间不一致解决" aria-hidden="true">#</a> Docker 容器日期与宿主主机时间不一致解决</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>失败：
