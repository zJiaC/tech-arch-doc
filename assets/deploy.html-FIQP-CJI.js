import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{r,o as l,c as t,a as d,b as e,d as a,e as n,f as c}from"./app-GbfL5fF9.js";const o={},p=e("h1",{id:"项目部署",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#项目部署","aria-hidden":"true"},"#"),a(" 项目部署")],-1),m=c(`<h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2><h3 id="docker-容器日期与宿主主机时间不一致解决" tabindex="-1"><a class="header-anchor" href="#docker-容器日期与宿主主机时间不一致解决" aria-hidden="true">#</a> Docker 容器日期与宿主主机时间不一致解决</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>失败：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul></li></ul><h2 id="收藏网址" tabindex="-1"><a class="header-anchor" href="#收藏网址" aria-hidden="true">#</a> 收藏网址</h2>`,7),u={href:"https://yeasy.gitbook.io/docker_practice/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.qikqiak.com/k8s-book/",target:"_blank",rel:"noopener noreferrer"};function b(h,_){const i=r("ExternalLinkIcon");return l(),t("div",null,[p,d(" more "),m,e("ul",null,[e("li",null,[e("a",u,[a("Docker-从入门到实践"),n(i)])]),e("li",null,[e("a",v,[a("从 Docker 到 Kubernetes 进阶"),n(i)])])])])}const g=s(o,[["render",b],["__file","deploy.html.vue"]]);export{g as default};
